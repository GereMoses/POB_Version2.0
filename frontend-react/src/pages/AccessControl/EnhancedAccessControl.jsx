/**
 * Enhanced Access Control - BioTime 9.5 Compatible + POB Extensions
 * Clean implementation with enhanced features and proper syntax
 */
...
import { 
  ...
  CheckCircle, XCircle, RefreshCw, Download, Lock
} from 'lucide-react';
...
const EnhancedAccessControl = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      description: 'Time zone configuration and management'
    },
    {
      id: 'levels',
      name: 'Access Levels',
      ...
      description: 'Access level assignments and permissions'
    },
    {
      id: 'doors',
      name: 'Door Settings',
      ...
      description: 'Door configuration and ADMS sync'
    },
    {
      id: 'events',
    ...
    },
    {
      ...
      description: 'Advanced event filtering and analytics'
    },
    {
      id: 'interlock',
      name: 'Interlock',
      ...
      description: 'Door interlock group management'
    },
    {
      id: 'antipassback',
      name: 'Anti-passback',
      ...
      description: 'Anti-passback configuration'
    },
    {
      id: 'firstcard',
      ...
      description: 'First-card open settings'
    },
    {
      id: 'linkage',
      name: 'Linkage',
      ...
      description: 'Input-output linkage rules'
    },
    {
      id: 'reports',
      name: 'Reports',
      ...
      description: 'Access control reports and analytics'
    },
    {
      id: 'emergency',
      name: 'Emergency',
      ...
      description: 'Emergency lockdown and mustering'
    }
  ];
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  <Users className={`w-5 h-5 mr-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`} />
                  <span className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                    {systemStats.onlineUsers} Users
                  </span>
                </div>
                <div className="flex items-center">
                  <Activity className={`w-5 h-5 mr-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`} />
                  <span className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                    {systemStats.totalEvents} Events
                  </span>
                </div>
              </div>
                  ...
                  <div key={tab.id} className="mb-2">
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        {tab.description && (
                          <span className={`block text-xs mt-1 ${isActive ? 'text-blue-100' : theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                            {tab.description}
                          </span>
                        )}
                      </div>
      ...
      {notifications.length > 0 && (
        <div className="fixed top-4 right-4 z-50 max-w-sm">
          <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg p-4 max-h-96 overflow-auto`}>
