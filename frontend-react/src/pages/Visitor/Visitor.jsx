...
const Visitor = () => {
  ...
  const tabItems = [
    { key: 'on-site',     label: <span><MonitorOutlined />On-Site Monitor</span>,    children: <OnSiteMonitor /> },
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Spin spinning={statsLoading}>
        <Row gutter={16} style={{ marginBottom: 24 }}>
          {[
            ...
            { title: 'On Site',           value: stats.on_site         ?? 0, color: '#52c41a', prefix: <MonitorOutlined /> },
            ...
            { title: 'Overstay',          value: stats.overstay_count  ?? 0, color: '#ff7a45', prefix: <WarningOutlined /> },
      ...
      <Card>
        <Tabs items={tabItems} size="small" defaultActiveKey="on-site" />
      </Card>
    </div>
  );
};
